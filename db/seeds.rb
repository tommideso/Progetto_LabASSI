...
menu1.update!(
  ...
  max_persone: 10,
  tipo_cucina: "Vegano",
  allergeni: { "glutine" => false, "soia" => true, "noci" => true },
  preferenze_alimentari: { "vegano" => true, "vegetariano" => true },
  adattabile: { "senza_glutine" => true, "senza_soia" => false },
...
menu2.update!(
  ...
  allergeni: { "glutine" => true, "soia" => false, "noci" => false },
  preferenze_alimentari: { "carnivoro" => true },
  adattabile: { "senza_glutine" => false, "senza_soia" => true },
